...
do
    ...
    local Files = {
        Lua = {
            Path = SCRIPT_PATH,
            Name = "Urgot.lua",
            Url = "https://raw.githubusercontent.com/miragessee/GoSUrgot/master/Urgot.lua"
        },
        Version = {
            Path = SCRIPT_PATH,
            Name = "miragesurgot.version",
            Url = "https://raw.githubusercontent.com/miragessee/GoSUrgot/master/miragesurgot.version"
        }
    }
...
function Urgot:LoadMenu()
    ...
    self.UrgotMenu = MenuElement({type = MENU, id = "Urgot", name = "Mirage's Urgot", leftIcon = HeroIcon})
...
function Urgot:LoadSpells()
    UrgotQ = {delay = 0.6, speed = math.huge, radius = 215, range = 800}
    UrgotW = {radius = 490, range = 490}
    UrgotE = {delay = 0.45, speed = 1050, radius = 100, range = 475}
    UrgotR = {delay = 0.4, speed = 3200, range = 1600, radius = 80}
